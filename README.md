...
| [`R-CMD-check.yaml`](.github/workflows/R-CMD-check.yaml) | R CMD check across multiple OS/R versions, including the minimum supported R 4.5; use `hard: true` for a hard-deps-only CI check (PR-only) | `extra-packages`, `hard` |
